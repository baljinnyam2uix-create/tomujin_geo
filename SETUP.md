...
### Сурах бичигт тулгуурлан хариулдаг болгох (RAG)
AI багш нь ЕБС-ийн газарзүйн сурах бичгээс холбогдох хэсгийг олж, түүнд тулгуурлан хариулна.

**1.** `supabase-migration-textbooks.sql`-ийг Supabase SQL Editor дээр нэг удаа ажиллуулна (pgvector өргөтгөл + `textbook_chunks` хүснэгт үүснэ).

**2.** Сурах бичгүүдийг оруулна. Локал дээрээ:

```
npm install pdf-parse
SUPABASE_URL=... SUPABASE_SERVICE_KEY=... OPENAI_API_KEY=... node scripts/ingest-textbooks.js "PDF-ийн хавтасны зам"
```

- `SUPABASE_SERVICE_KEY` = Supabase > Settings > API > **service_role** key. Зөвхөн локалаар ашиглана, git-д хэзээ ч бүү оруул.
- Скрипт нь 7–11-р ангийн сурах бичгийг файлын нэрээр таньж, ангид нь хуваарилна. Шинэ ном нэмэх бол скриптийн эхэн дэх `GRADE_BY_FILE` жагсаалтад бүртгэнэ.
- Дахин ажиллуулахад хуучин өгөгдлийг цэвэрлээд шинээр оруулна.
- Зардал маш бага: 5 сурах бичгийг индексжүүлэхэд ойролцоогоор **$0.01**.

**Хэрхэн ажилладаг вэ:** сурагчийн асуултыг вектор болгож, өөрийнх нь ангиас доош түвшний сурах бичгээс хамгийн ойр 5 хэсгийг олж, AI-д өгнө. Тохирол сул (0.3-аас доош) бол хаяна. Хайлт бүтэхгүй эсвэл ном оруулаагүй бол AI ердийн горимоороо хариулсаар байна.
